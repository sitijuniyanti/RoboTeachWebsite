...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  set_flash_message('warning', 'Data Alat', 'Tentukan data alat yang akan dubah');
  redirect_url('admin/alat');
  die();
}
?>
...
<head>
  ...
  <title><?= SITE_NAME ?> - Ubah Alat</title>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Form Ubah Data Alat</h3>
                </div>


                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" name="form" action="<?= base_url('admin/alat/edit') ?>" method="POST">
                  <div class="box-body">
                    <?php
                    require_once view_path('part/flash-message.php');
                    ?>
                    <input type="hidden" value="<?= $alat['id_alat'] ?>" name="old_id_alat">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <div class="form-group has-feedback <?= input_error('id_alat') ? 'has-error' : null ?> ">
                          <input type="text" value="<?= set_value('id_alat', $alat['id_alat']) ?>" id="idalat" name="id_alat" class="form-control" placeholder="Id Alat">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <div class="form-group has-feedback <?= input_error('nama_alat') ? 'has-error' : null ?> ">
                          <input type="text" value="<?= set_value('nama_alat', $alat['nama_alat']) ?>" id="namaalat" name="nama_alat" class="form-control" placeholder="Nama Alat">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <div class="form-group has-feedback <?= input_error('stok') ? 'has-error' : null ?> ">
                          <input type="text" value="<?= set_value('stok', $alat['stok']) ?>" id="stok" name="stok" class="form-control" placeholder="Stok">
