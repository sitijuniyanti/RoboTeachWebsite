...
if (isset($_SESSION['level']) && $_SESSION['level'] == "SEKOLAH") {
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?= baseUrl('resource/img/usersekolah.png'); ?>" class="user-image" alt="User Image">
                <span class="hidden-xs">SD 01</span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?= baseUrl('resource/img/usersekolah.png'); ?>" class="img-circle" alt="User Image">
