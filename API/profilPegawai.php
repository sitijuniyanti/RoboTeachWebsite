<?php
   ...
   */ date_default_timezone_set('Asia/Jakarta');
    ...
    $db = new DbHandler();
    $db->profilPegawai($id, $nama_l, $nama_p, $status, $jk, $tempat_lahir, $tgl_lahir, $kontak, $alamat, $email, 
    $tahun_join, $password, $foto, $foto_temp,$passwordLama,$passwordBaru,$passwordUlang);
?>