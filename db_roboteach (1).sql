...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2020 at 04:59 PM
...
CREATE TABLE `pengajar` (
  ...
  `status` enum('Tetap','Freelance') NOT NULL,
...
('19031', 1, 'Siti Juniyanti', 'Anty', 'Freelance', 'P', 'Bandung', '1998-06-26', '085656064177', 'Jalan Sekeloa Selatan No 29', 'sitijuniyanti@gmail.com', '2018', 'anti.jpg', '123', NULL, NULL);
...
(1, 'sitijuniyanti', '81dc9bdb52d04dc20036dbd8313ed055', 'PENGAJAR'),
...
ALTER TABLE `cuaca`
  ...
  ADD UNIQUE KEY `id_sekolah_unique` (`id_sekolah`);
...
ALTER TABLE `jadwal`
  ...
  ADD UNIQUE KEY `id_sekolah_idx` (`id_sekolah`);
...
ALTER TABLE `sekolah`
  ...
  ADD CONSTRAINT `sekolah_ibfk_2` FOREIGN KEY (`id_sekolah`) REFERENCES `cuaca` (`id_sekolah`);
COMMIT;
